...
.step-line {
  ...
  width: 100%;
  height: 0.125rem;
  background-color:color-mix(in oklab, var(--cml-m3-outline) 100%, transparent);
...
.step-line-complete {
  background-color: color-mix(in oklab, var(--cml-m3-primary) 100%, white) !important;
}
...
.step-dot {
  ...
  transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);
  transition-duration: 300ms;
  background-color: color-mix(in oklab, var(--cml-m3-surface) 100%, transparent);
}

.step-dot-doing {
  border-color: color-mix(in oklab, var(--cml-m3-primary) 100%, white) !important;
}
...
.step-dot-text-doing {
  color: color-mix(in oklab, var(--cml-m3-primary) 100%, white) !important;
}

.step-dot-text-complete {
  user-select: none;
  color: color-mix(in oklab, var(--cml-m3-on-primary) 100%, transparent);
}
